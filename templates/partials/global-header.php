...
<div class="monkeypay-global-header">
    ...
    <nav class="monkeypay-global-nav">
        ...
        <a href="<?php echo admin_url( 'admin.php?page=' . $page_slug ); ?>"
            ...
            <span class="monkeypay-nav-label" data-i18n="<?php echo esc_attr( $item['i18n'] ); ?>"><?php echo esc_html( $item['title'] ); ?></span>
        </a>
        <?php endforeach; ?>
    </nav>
</div>
