...
define('MONKEYPAY_VERSION', '3.4.0');
...
/**
 * Check if MonkeyPay is active and configured.
 * Used by Checkin plugin to enable reconciliation features.
 *
 * @return bool
 */
function is_monkeypay_mode()
{
    // MonkeyPay is active if this file is loaded
    return true;
}
